...
// Erase these lines and put your rules here to recognize
//	floats, integers, <, <=, >, >=, ==, !=, =, *, /, +, -, (, ), :, ;, 
//	if, elif, else, while, print, True, False, or, and,
//	"Strings in double quotes"
//	'Strings in single quotes'
//	identifier(s) (the Python grammar calls them "names") and commas (,)
.			{
